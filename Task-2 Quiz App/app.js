...
let questions = [
    new Question(
        "1.Hyper Text Markup Language Stands For?", 
        ["JQuery", "XHTML","CSS", "HTML"], "HTML"
    ),
    new Question(
        "2.Cascading Style sheet stands for?", 
        ["HTML", "JQuery", "CSS", "XML"], "CSS"
    ),
    new Question(
        "3.Which is a JavaScript Framework?", 
        ["React", "Laravel","Django", "Sass"], "React"
        ),
    new Question(
        "4.Which is a backend language?", 
        ["PHP", "HTML", "React", "All"], "PHP"
        ),
    new Question(
        "5.Which is best for Artificial intelligence?", 
